...
namespace InetStudio\CustomFields\Console\Commands;
...
class SetupCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'inetstudio:custom-fields:setup';
    ...
    private function initCommands(): void
    {
        $this->calls = [
            [
                ...
                'params' => [
                    '--provider' => 'InetStudio\CustomFields\Providers\CustomFieldsServiceProvider',
                    '--tag' => 'migrations',
                ],
            ],
            [
